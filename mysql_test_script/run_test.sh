...
#dir=${home}/mytest_8/bin
script=scripts

if [ ${2} -eq 1 ];then
	result=/home/som/test_hdd/mysql_result/nvme/ro/8/single
else
	result=/home/som/test_hdd/mysql_result/nvme/8/single
fi
...
do
	...
	./mysql -u root -D tpch -e 'SHOW GLOBAL STATUS;' | grep Innodb > ${result}/${i}_stat_after
