...
if [ ${2} -eq 1 ];then #read only or not
	result=/home/som/test_hdd/mysql_result/nvme/ro/test
else
	result=/home/som/test_hdd/mysql_result/nvme/test/single
fi
